...
class CompositionInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "dateCompleted" => Deserialize::dateTime(
                Values::array_get($payload, "date_completed")
            ),
            "dateDeleted" => Deserialize::dateTime(
                Values::array_get($payload, "date_deleted")
            ),
            "sid" => Values::array_get($payload, "sid"),
            "roomSid" => Values::array_get($payload, "room_sid"),
            "audioSources" => Values::array_get($payload, "audio_sources"),
            "audioSourcesExcluded" => Values::array_get(
                $payload,
            ...
            "mediaExternalLocation" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Video.V1.CompositionInstance " .
            \implode(" ", $context) .
            "]";
    }
}
