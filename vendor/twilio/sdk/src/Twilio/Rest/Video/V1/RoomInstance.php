...
class RoomInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "maxParticipantDuration" => Values::array_get(
                $payload,
                "max_participant_duration"
            ),
            "maxConcurrentPublishedTracks" => Values::array_get(
                $payload,
                "max_concurrent_published_tracks"
            ),
            "recordParticipantsOnConnect" => Values::array_get(
                $payload,
            ...
            "emptyRoomTimeout" => Values::array_get(
                $payload,
                "empty_room_timeout"
            ),
            "unusedRoomTimeout" => Values::array_get(
                $payload,
                "unused_room_timeout"
            ),
