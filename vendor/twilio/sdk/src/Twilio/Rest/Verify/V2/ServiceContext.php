...
class ServiceContext extends InstanceContext
{
    ...
    public function update(array $options = []): ServiceInstance
    {
        ...
        $data = Values::of([
            ...
            "LookupEnabled" => Serialize::booleanToString(
                $options["lookupEnabled"]
            ),
            "SkipSmsToLandlines" => Serialize::booleanToString(
                $options["skipSmsToLandlines"]
            ),
            "DtmfInputRequired" => Serialize::booleanToString(
                $options["dtmfInputRequired"]
            ),
            "TtsName" => $options["ttsName"],
            "Psd2Enabled" => Serialize::booleanToString(
                $options["psd2Enabled"]
            ),
            "DoNotShareWarningEnabled" => Serialize::booleanToString(
                $options["doNotShareWarningEnabled"]
            ),
            "CustomCodeEnabled" => Serialize::booleanToString(
                $options["customCodeEnabled"]
            ),
            "Push.IncludeDate" => Serialize::booleanToString(
                $options["pushIncludeDate"]
            ),
            ...
            "VerifyEventSubscriptionEnabled" => Serialize::booleanToString(
                $options["verifyEventSubscriptionEnabled"]
            ),
        ]);
