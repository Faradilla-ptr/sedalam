...
class ChallengeInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "dateResponded" => Deserialize::dateTime(
                Values::array_get($payload, "date_responded")
            ),
            "expirationDate" => Deserialize::dateTime(
                Values::array_get($payload, "expiration_date")
            ),
            "status" => Values::array_get($payload, "status"),
            "respondedReason" => Values::array_get(
                $payload,
                "responded_reason"
            ),
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Verify.V2.ChallengeInstance " .
            \implode(" ", $context) .
            "]";
    }
}
