...
class ServiceInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "skipSmsToLandlines" => Values::array_get(
                $payload,
                "skip_sms_to_landlines"
            ),
            "dtmfInputRequired" => Values::array_get(
                $payload,
                "dtmf_input_required"
            ),
            "ttsName" => Values::array_get($payload, "tts_name"),
            "doNotShareWarningEnabled" => Values::array_get(
                $payload,
                "do_not_share_warning_enabled"
            ),
            "customCodeEnabled" => Values::array_get(
                $payload,
                "custom_code_enabled"
            ),
            "push" => Values::array_get($payload, "push"),
            "totp" => Values::array_get($payload, "totp"),
            "defaultTemplateSid" => Values::array_get(
                $payload,
                "default_template_sid"
            ),
            "whatsapp" => Values::array_get($payload, "whatsapp"),
            "verifyEventSubscriptionEnabled" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Verify.V2.ServiceInstance " .
            \implode(" ", $context) .
            "]";
    }
}
