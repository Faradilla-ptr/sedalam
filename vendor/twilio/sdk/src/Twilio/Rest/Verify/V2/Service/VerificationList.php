...
class VerificationList extends ListResource
{
    ...
    public function __construct(Version $version, string $serviceSid)
    {
        ...
        $this->uri =
            "/Services/" . \rawurlencode($serviceSid) . "/Verifications";
    }
    ...
    public function create(
        ...
        $data = Values::of([
            ...
            "ChannelConfiguration" => Serialize::jsonObject(
            ...
            "EnableSnaClientToken" => Serialize::booleanToString(
                $options["enableSnaClientToken"]
            ),
