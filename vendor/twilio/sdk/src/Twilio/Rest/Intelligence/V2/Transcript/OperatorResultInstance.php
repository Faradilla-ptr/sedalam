...
class OperatorResultInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "matchProbability" => Values::array_get(
                $payload,
                "match_probability"
            ),
            "normalizedResult" => Values::array_get(
                $payload,
                "normalized_result"
            ),
            "utteranceResults" => Values::array_get(
                $payload,
                "utterance_results"
            ),
            "utteranceMatch" => Values::array_get($payload, "utterance_match"),
            "predictedLabel" => Values::array_get($payload, "predicted_label"),
            "predictedProbability" => Values::array_get(
                $payload,
                "predicted_probability"
            ),
            "labelProbabilities" => Values::array_get(
                $payload,
                "label_probabilities"
            ),
            "extractResults" => Values::array_get($payload, "extract_results"),
            "textGenerationResults" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Intelligence.V2.OperatorResultInstance " .
            \implode(" ", $context) .
            "]";
    }
}
