...
abstract class OperatorResultOptions
{
    ...
    public static function fetch(
        ...
        return new FetchOperatorResultOptions($redacted);
    }
    ...
    public static function read(
        ...
        return new ReadOperatorResultOptions($redacted);
    }
}
...
class FetchOperatorResultOptions extends Options
{
     ...
     * @param bool $redacted Grant access to PII redacted/unredacted Language Understanding operator. If redaction is enabled, the default is True.
     */
    public function __construct(bool $redacted = Values::BOOL_NONE)
    {
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Intelligence.V2.FetchOperatorResultOptions " .
            $options .
            "]";
    }
}
...
class ReadOperatorResultOptions extends Options
{
    ...
    {
        $options = \http_build_query(Values::of($this->options), "", " ");
        return "[Twilio.Intelligence.V2.ReadOperatorResultOptions " .
            $options .
            "]";
    }
}
