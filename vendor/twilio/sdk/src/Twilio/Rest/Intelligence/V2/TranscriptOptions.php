...
abstract class TranscriptOptions
{
    ...
    public static function create(
        ...
        return new CreateTranscriptOptions($customerKey, $mediaStartTime);
    }
...
class CreateTranscriptOptions extends Options
{
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Intelligence.V2.CreateTranscriptOptions " .
            $options .
            "]";
    }
}
...
class ReadTranscriptOptions extends Options
{
    ...
    {
        $options = \http_build_query(Values::of($this->options), "", " ");
        return "[Twilio.Intelligence.V2.ReadTranscriptOptions " .
            $options .
            "]";
    }
}
