...
class NotificationInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "messageDate" => Deserialize::dateTime(
                Values::array_get($payload, "message_date")
            ),
            ...
            "requestVariables" => Values::array_get(
                $payload,
                "request_variables"
            ),
            "responseBody" => Values::array_get($payload, "response_body"),
            "responseHeaders" => Values::array_get(
                $payload,
                "response_headers"
            ),
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Api.V2010.NotificationInstance " .
            \implode(" ", $context) .
            "]";
    }
}
