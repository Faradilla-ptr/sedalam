...
class ApplicationList extends ListResource
{
    ...
    public function __construct(Version $version, string $accountSid)
    {
        ...
        $this->uri =
            "/Accounts/" . \rawurlencode($accountSid) . "/Applications.json";
    }
    ...
    public function create(array $options = []): ApplicationInstance
    {
        ...
        $data = Values::of([
            ...
            "VoiceCallerIdLookup" => Serialize::booleanToString(
                $options["voiceCallerIdLookup"]
            ),
            ...
            "PublicApplicationConnectEnabled" => Serialize::booleanToString(
                $options["publicApplicationConnectEnabled"]
            ),
        ]);
