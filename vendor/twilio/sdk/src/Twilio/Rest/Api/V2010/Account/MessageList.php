...
class MessageList extends ListResource
{
    ...
    public function create(string $to, array $options = []): MessageInstance
    {
        ...
        $data = Values::of([
            ...
            "ProvideFeedback" => Serialize::booleanToString(
                $options["provideFeedback"]
            ),
            "Attempt" => $options["attempt"],
            "ValidityPeriod" => $options["validityPeriod"],
            "ForceDelivery" => Serialize::booleanToString(
                $options["forceDelivery"]
            ),
            "ContentRetention" => $options["contentRetention"],
            "AddressRetention" => $options["addressRetention"],
            "SmartEncoded" => Serialize::booleanToString(
                $options["smartEncoded"]
            ),
            "PersistentAction" => Serialize::map(
                $options["persistentAction"],
                function ($e) {
                    return $e;
                }
            ),
            "TrafficType" => $options["trafficType"],
            "ShortenUrls" => Serialize::booleanToString(
                $options["shortenUrls"]
            ),
    ...
    public function page(
        ...
        $params = Values::of([
            "To" => $options["to"],
            "From" => $options["from"],
            "DateSent<" => Serialize::iso8601DateTime(
