...
class ConferenceList extends ListResource
{
    ...
    public function __construct(Version $version, string $accountSid)
    {
        ...
        $this->uri =
            "/Accounts/" . \rawurlencode($accountSid) . "/Conferences.json";
    }
    ...
    public function page(
        ...
        $params = Values::of([
            "DateCreated<" => Serialize::iso8601Date(
            ...
            "DateUpdated<" => Serialize::iso8601Date(
                $options["dateUpdatedBefore"]
            ),
            "DateUpdated" => Serialize::iso8601Date($options["dateUpdated"]),
            "DateUpdated>" => Serialize::iso8601Date(
                $options["dateUpdatedAfter"]
            ),
