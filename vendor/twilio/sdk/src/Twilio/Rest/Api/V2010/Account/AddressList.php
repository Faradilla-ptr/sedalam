...
class AddressList extends ListResource
{
    ...
    public function __construct(Version $version, string $accountSid)
    {
        ...
        $this->uri =
            "/Accounts/" . \rawurlencode($accountSid) . "/Addresses.json";
    }
    ...
    public function create(
        ...
        $data = Values::of([
            ...
            "EmergencyEnabled" => Serialize::booleanToString(
                $options["emergencyEnabled"]
            ),
            "AutoCorrectAddress" => Serialize::booleanToString(
                $options["autoCorrectAddress"]
            ),
