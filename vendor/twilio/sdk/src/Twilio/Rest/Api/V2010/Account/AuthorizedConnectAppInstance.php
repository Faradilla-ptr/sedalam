...
class AuthorizedConnectAppInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "connectAppCompanyName" => Values::array_get(
                $payload,
                "connect_app_company_name"
            ),
            "connectAppDescription" => Values::array_get(
                $payload,
                "connect_app_description"
            ),
            "connectAppFriendlyName" => Values::array_get(
                $payload,
                "connect_app_friendly_name"
            ),
            "connectAppHomepageUrl" => Values::array_get(
                $payload,
        ...
        $this->solution = [
            ...
            "connectAppSid" =>
                $connectAppSid ?: $this->properties["connectAppSid"],
        ];
    }
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Api.V2010.AuthorizedConnectAppInstance " .
            \implode(" ", $context) .
            "]";
    }
}
