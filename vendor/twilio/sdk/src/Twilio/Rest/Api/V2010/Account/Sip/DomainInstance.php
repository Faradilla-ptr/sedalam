...
class DomainInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "voiceStatusCallbackMethod" => Values::array_get(
                $payload,
                "voice_status_callback_method"
            ),
            "voiceStatusCallbackUrl" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Api.V2010.DomainInstance " .
            \implode(" ", $context) .
            "]";
    }
}
