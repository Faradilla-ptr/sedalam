...
class MachineToMachineList extends ListResource
{
    ...
    public function page(
        ...
        $params = Values::of([
            ...
            "VoiceEnabled" => Serialize::booleanToString(
                $options["voiceEnabled"]
            ),
            "ExcludeAllAddressRequired" => Serialize::booleanToString(
                $options["excludeAllAddressRequired"]
            ),
            "ExcludeLocalAddressRequired" => Serialize::booleanToString(
                $options["excludeLocalAddressRequired"]
            ),
            "ExcludeForeignAddressRequired" => Serialize::booleanToString(
                $options["excludeForeignAddressRequired"]
            ),
        ...
        return new MachineToMachinePage(
            $this->version,
            $response,
            $this->solution
        );
