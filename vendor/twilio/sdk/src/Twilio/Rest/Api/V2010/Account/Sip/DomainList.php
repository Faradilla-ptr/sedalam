...
class DomainList extends ListResource
{
    ...
    public function __construct(Version $version, string $accountSid)
    {
        ...
        $this->uri =
            "/Accounts/" . \rawurlencode($accountSid) . "/SIP/Domains.json";
    }
    ...
    public function create(
        ...
        $data = Values::of([
            ...
            "SipRegistration" => Serialize::booleanToString(
                $options["sipRegistration"]
            ),
            "EmergencyCallingEnabled" => Serialize::booleanToString(
                $options["emergencyCallingEnabled"]
            ),
