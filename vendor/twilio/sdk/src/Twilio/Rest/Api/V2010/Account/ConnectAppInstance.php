...
class ConnectAppInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "authorizeRedirectUrl" => Values::array_get(
                $payload,
                "authorize_redirect_url"
            ),
            "companyName" => Values::array_get($payload, "company_name"),
            "deauthorizeCallbackMethod" => Values::array_get(
                $payload,
                "deauthorize_callback_method"
            ),
            "deauthorizeCallbackUrl" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Api.V2010.ConnectAppInstance " .
            \implode(" ", $context) .
            "]";
    }
}
