...
class ComplianceRegistrationInquiriesList extends ListResource
{
    ...
    public function create(
        ...
        $data = Values::of([
            ...
            "AcceptedNotificationReceipt" => Serialize::booleanToString(
                $options["acceptedNotificationReceipt"]
            ),
            ...
            "UseAddressAsEmergencyAddress" => Serialize::booleanToString(
                $options["useAddressAsEmergencyAddress"]
            ),
