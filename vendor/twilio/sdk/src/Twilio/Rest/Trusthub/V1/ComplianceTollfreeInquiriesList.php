...
class ComplianceTollfreeInquiriesList extends ListResource
{
    ...
    public function create(
        ...
        $data = Values::of([
            ...
            "UseCaseCategories" => Serialize::map(
            ...
            "OptInImageUrls" => Serialize::map(
                $options["optInImageUrls"],
                function ($e) {
                    return $e;
                }
            ),
            ...
            "SkipMessagingUseCase" => Serialize::booleanToString(
                $options["skipMessagingUseCase"]
            ),
        ]);
