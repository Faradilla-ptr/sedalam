...
class PhoneNumberInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            "callingCountryCode" => Values::array_get(
                $payload,
            ...
            "validationErrors" => Values::array_get(
                $payload,
                "validation_errors"
            ),
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Lookups.V2.PhoneNumberInstance " .
            \implode(" ", $context) .
            "]";
    }
}
