...
abstract class KnowledgeModels
{
     ...
     */
    public static function createKnowledgeV1ServiceCreatePolicyRequest(
        array $payload = []
     ...
     */
    public static function createKnowledgeV1ServiceCreateKnowledgeRequest(
        array $payload = []
     ...
     */
    public static function createKnowledgeV1ServiceUpdateKnowledgeRequest(
        array $payload = []
