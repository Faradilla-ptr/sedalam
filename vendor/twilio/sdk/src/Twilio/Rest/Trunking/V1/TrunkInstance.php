...
class TrunkInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "disasterRecoveryMethod" => Values::array_get(
                $payload,
                "disaster_recovery_method"
            ),
            "disasterRecoveryUrl" => Values::array_get(
                $payload,
            ...
            "transferCallerId" => Values::array_get(
                $payload,
                "transfer_caller_id"
            ),
            "cnamLookupEnabled" => Values::array_get(
                $payload,
                "cnam_lookup_enabled"
            ),
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Trunking.V1.TrunkInstance " .
            \implode(" ", $context) .
            "]";
    }
}
