...
abstract class AuthorizationDocumentOptions
{
    ...
    public static function create(
        ...
        return new CreateAuthorizationDocumentOptions($contactTitle, $ccEmails);
    }
...
class CreateAuthorizationDocumentOptions extends Options
{
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Numbers.V2.CreateAuthorizationDocumentOptions " .
            $options .
            "]";
    }
}
...
class ReadAuthorizationDocumentOptions extends Options
{
    ...
    {
        $options = \http_build_query(Values::of($this->options), "", " ");
        return "[Twilio.Numbers.V2.ReadAuthorizationDocumentOptions " .
            $options .
            "]";
    }
}
