...
class CreateHostedNumberOrderOptions extends Options
{
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Numbers.V2.CreateHostedNumberOrderOptions " .
            $options .
            "]";
    }
}
...
class ReadHostedNumberOrderOptions extends Options
{
    ...
    {
        $options = \http_build_query(Values::of($this->options), "", " ");
        return "[Twilio.Numbers.V2.ReadHostedNumberOrderOptions " .
            $options .
            "]";
    }
}
...
class UpdateHostedNumberOrderOptions extends Options
{
     ...
     * @return $this Fluent Builder
     */
    public function setVerificationCallExtension(
    ...
    {
        $options = \http_build_query(Values::of($this->options), "", " ");
        return "[Twilio.Numbers.V2.UpdateHostedNumberOrderOptions " .
            $options .
            "]";
    }
}
