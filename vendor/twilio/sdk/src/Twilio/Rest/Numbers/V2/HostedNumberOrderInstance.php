...
class HostedNumberOrderInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "incomingPhoneNumberSid" => Values::array_get(
                $payload,
                "incoming_phone_number_sid"
            ),
            "addressSid" => Values::array_get($payload, "address_sid"),
            "signingDocumentSid" => Values::array_get(
                $payload,
            ...
            "contactPhoneNumber" => Values::array_get(
                $payload,
                "contact_phone_number"
            ),
            "bulkHostingRequestSid" => Values::array_get(
                $payload,
                "bulk_hosting_request_sid"
            ),
            "nextStep" => Values::array_get($payload, "next_step"),
            "verificationAttempts" => Values::array_get(
                $payload,
                "verification_attempts"
            ),
            "verificationCallSids" => Values::array_get(
                $payload,
                "verification_call_sids"
            ),
            "verificationCallDelay" => Values::array_get(
                $payload,
                "verification_call_delay"
            ),
            "verificationCallExtension" => Values::array_get(
                $payload,
                "verification_call_extension"
            ),
            "verificationCode" => Values::array_get(
                $payload,
                "verification_code"
            ),
            "verificationType" => Values::array_get(
                $payload,
                "verification_type"
            ),
        ];
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Numbers.V2.HostedNumberOrderInstance " .
            \implode(" ", $context) .
            "]";
    }
}
