...
class BundleList extends ListResource
{
    ...
    public function page(
        ...
        $params = Values::of([
            ...
            "IsoCountry" => $options["isoCountry"],
            "NumberType" => $options["numberType"],
            "HasValidUntilDate" => Serialize::booleanToString(
                $options["hasValidUntilDate"]
            ),
            "SortBy" => $options["sortBy"],
            "SortDirection" => $options["sortDirection"],
            "ValidUntilDate<" => Serialize::iso8601DateTime(
                $options["validUntilDateBefore"]
            ),
            "ValidUntilDate" => Serialize::iso8601DateTime(
                $options["validUntilDate"]
            ),
            "ValidUntilDate>" => Serialize::iso8601DateTime(
                $options["validUntilDateAfter"]
            ),
            "PageToken" => $pageToken,
            "Page" => $pageNumber,
            "PageSize" => $pageSize,
