...
class PortingPortInPhoneNumberInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            "portInRequestSid" => Values::array_get(
                $payload,
                "port_in_request_sid"
            ),
            ...
            "phoneNumberType" => Values::array_get(
                $payload,
                "phone_number_type"
            ),
            ...
            "missingRequiredFields" => Values::array_get(
                $payload,
                "missing_required_fields"
            ),
            "lastUpdated" => Deserialize::dateTime(
                Values::array_get($payload, "last_updated")
            ),
            "phoneNumber" => Values::array_get($payload, "phone_number"),
            "portable" => Values::array_get($payload, "portable"),
            "notPortabilityReason" => Values::array_get(
                $payload,
                "not_portability_reason"
            ),
            "notPortabilityReasonCode" => Values::array_get(
                $payload,
                "not_portability_reason_code"
            ),
            "portInPhoneNumberStatus" => Values::array_get(
                $payload,
            ...
            "rejectionReasonCode" => Values::array_get(
                $payload,
                "rejection_reason_code"
            ),
            "portDate" => Deserialize::dateTime(
                Values::array_get($payload, "port_date")
            ),
        ];

        $this->solution = [
            "portInRequestSid" =>
                $portInRequestSid ?: $this->properties["portInRequestSid"],
            "phoneNumberSid" =>
                $phoneNumberSid ?: $this->properties["phoneNumberSid"],
        ];
    }
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Numbers.V1.PortingPortInPhoneNumberInstance " .
            \implode(" ", $context) .
            "]";
    }
}
