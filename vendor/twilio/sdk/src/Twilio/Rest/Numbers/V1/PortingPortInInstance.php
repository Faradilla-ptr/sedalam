...
class PortingPortInInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "notificationEmails" => Values::array_get(
                $payload,
                "notification_emails"
            ),
            "targetPortInDate" => Deserialize::dateTime(
                Values::array_get($payload, "target_port_in_date")
            ),
            "targetPortInTimeRangeStart" => Values::array_get(
                $payload,
                "target_port_in_time_range_start"
            ),
            "targetPortInTimeRangeEnd" => Values::array_get(
                $payload,
                "target_port_in_time_range_end"
            ),
            "portInRequestStatus" => Values::array_get(
                $payload,
                "port_in_request_status"
            ),
            "losingCarrierInformation" => Values::array_get(
                $payload,
