...
abstract class UserOptions
{
     ...
     */
    public static function read(string $filter = Values::NONE): ReadUserOptions
    {
        return new ReadUserOptions($filter);
    }
    ...
    public static function update(
        ...
        return new UpdateUserOptions($ifMatch);
    }
}
...
class ReadUserOptions extends Options
{
     ...
     * @param string $filter
     */
    public function __construct(string $filter = Values::NONE)
    {
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.PreviewIam.Versionless.ReadUserOptions " .
            $options .
            "]";
    }
}
...
class UpdateUserOptions extends Options
{
    ...
    {
        $options = \http_build_query(Values::of($this->options), "", " ");
        return "[Twilio.PreviewIam.Versionless.UpdateUserOptions " .
            $options .
            "]";
    }
}
