...
class RoleAssignmentList extends ListResource
{
     ...
     */
    public function __construct(Version $version, string $organizationSid)
    {
        ...
        $this->uri = "/" . \rawurlencode($organizationSid) . "/RoleAssignments";
    }
     ...
     * @param string $sid
     */
    public function getContext(string $sid): RoleAssignmentContext
    {
