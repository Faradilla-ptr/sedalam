...
class DataSessionInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "operatorCountry" => Values::array_get(
                $payload,
                "operator_country"
            ),
            "operatorName" => Values::array_get($payload, "operator_name"),
            "cellId" => Values::array_get($payload, "cell_id"),
            "cellLocationEstimate" => Values::array_get(
                $payload,
                "cell_location_estimate"
            ),
            "packetsUploaded" => Values::array_get(
                $payload,
                "packets_uploaded"
            ),
            "packetsDownloaded" => Values::array_get(
                $payload,
                "packets_downloaded"
            ),
            ...
            "start" => Deserialize::dateTime(
                Values::array_get($payload, "start")
            ),
