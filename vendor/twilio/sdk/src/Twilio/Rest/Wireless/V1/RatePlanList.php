...
class RatePlanList extends ListResource
{
    ...
    public function create(array $options = []): RatePlanInstance
    {
        ...
        $data = Values::of([
            ...
            "DataEnabled" => Serialize::booleanToString(
                $options["dataEnabled"]
            ),
            "DataLimit" => $options["dataLimit"],
            "DataMetering" => $options["dataMetering"],
            "MessagingEnabled" => Serialize::booleanToString(
                $options["messagingEnabled"]
            ),
            "VoiceEnabled" => Serialize::booleanToString(
                $options["voiceEnabled"]
            ),
            "NationalRoamingEnabled" => Serialize::booleanToString(
                $options["nationalRoamingEnabled"]
            ),
            "InternationalRoaming" => Serialize::map(
                $options["internationalRoaming"],
                function ($e) {
                    return $e;
                }
            ),
            ...
            "DataLimitStrategy" => $options["dataLimitStrategy"],
        ]);
