...
class Trusthub extends TrusthubBase
{
     ...
     */
    protected function contextCustomerProfiles(
        string $sid
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextEndUsers(
        string $sid
    ): \Twilio\Rest\Trusthub\V1\EndUserContext {
     ...
     *                    resource
     */
    protected function contextEndUserTypes(
        string $sid
     ...
     */
    protected function contextPolicies(
        string $sid
    ): \Twilio\Rest\Trusthub\V1\PoliciesContext {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextSupportingDocuments(
        string $sid
    ): \Twilio\Rest\Trusthub\V1\SupportingDocumentContext {
     ...
     *                    Type resource
     */
    protected function contextSupportingDocumentTypes(
        string $sid
     ...
     * @param string $sid The unique string that identifies the resource.
     */
    protected function contextTrustProducts(
        string $sid
