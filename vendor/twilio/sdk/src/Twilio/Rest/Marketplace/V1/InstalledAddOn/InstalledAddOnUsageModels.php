...
abstract class InstalledAddOnUsageModels
{
     ...
     */
    public static function createMarketplaceV1InstalledAddOnInstalledAddOnUsageBillableItems(
        array $payload = []
     ...
     */
    public static function createMarketplaceV1InstalledAddOnInstalledAddOnUsage(
        array $payload = []
...
class MarketplaceV1InstalledAddOnInstalledAddOnUsageBillableItems implements
    \JsonSerializable
{
    /**
     * @property string $quantity Total amount in local currency that was billed for this Billing Item. Can be any floating number greater than 0.
...
class MarketplaceV1InstalledAddOnInstalledAddOnUsage implements
    \JsonSerializable
{
    /**
     * @property string $totalSubmitted Total amount in local currency that was billed in this request. Aggregates all billable_items that were successfully submitted.
