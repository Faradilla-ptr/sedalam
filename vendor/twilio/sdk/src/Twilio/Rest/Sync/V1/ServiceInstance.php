...
class ServiceInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "webhooksFromRestEnabled" => Values::array_get(
                $payload,
                "webhooks_from_rest_enabled"
            ),
            "reachabilityWebhooksEnabled" => Values::array_get(
                $payload,
                "reachability_webhooks_enabled"
            ),
            "aclEnabled" => Values::array_get($payload, "acl_enabled"),
            "reachabilityDebouncingEnabled" => Values::array_get(
                $payload,
                "reachability_debouncing_enabled"
            ),
            "reachabilityDebouncingWindow" => Values::array_get(
                $payload,
