...
class ServiceContext extends InstanceContext
{
    ...
    public function update(array $options = []): ServiceInstance
    {
        ...
        $data = Values::of([
            ...
            "ReachabilityWebhooksEnabled" => Serialize::booleanToString(
                $options["reachabilityWebhooksEnabled"]
            ),
            "AclEnabled" => Serialize::booleanToString($options["aclEnabled"]),
            "ReachabilityDebouncingEnabled" => Serialize::booleanToString(
                $options["reachabilityDebouncingEnabled"]
            ),
            "ReachabilityDebouncingWindow" =>
                $options["reachabilityDebouncingWindow"],
            "WebhooksFromRestEnabled" => Serialize::booleanToString(
                $options["webhooksFromRestEnabled"]
            ),
        ]);
