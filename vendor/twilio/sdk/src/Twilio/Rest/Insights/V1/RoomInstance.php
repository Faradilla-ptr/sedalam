...
class RoomInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "uniqueParticipantIdentities" => Values::array_get(
                $payload,
                "unique_participant_identities"
            ),
            "concurrentParticipants" => Values::array_get(
                $payload,
            ...
            "totalParticipantDurationSec" => Values::array_get(
                $payload,
                "total_participant_duration_sec"
            ),
            "totalRecordingDurationSec" => Values::array_get(
                $payload,
        ...
        $this->solution = [
            "roomSid" => $roomSid ?: $this->properties["roomSid"],
        ];
    }
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Insights.V1.RoomInstance " .
            \implode(" ", $context) .
            "]";
    }
}
