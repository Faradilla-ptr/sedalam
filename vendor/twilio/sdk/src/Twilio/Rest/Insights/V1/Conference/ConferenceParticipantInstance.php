...
class ConferenceParticipantInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "joinTime" => Deserialize::dateTime(
                Values::array_get($payload, "join_time")
            ),
            "leaveTime" => Deserialize::dateTime(
                Values::array_get($payload, "leave_time")
            ),
            "durationSeconds" => Values::array_get(
                $payload,
                "duration_seconds"
            ),
            "outboundQueueLength" => Values::array_get(
                $payload,
                "outbound_queue_length"
            ),
            "outboundTimeInQueue" => Values::array_get(
                $payload,
                "outbound_time_in_queue"
            ),
            "jitterBufferSize" => Values::array_get(
                $payload,
                "jitter_buffer_size"
            ),
            "isCoach" => Values::array_get($payload, "is_coach"),
            "coachedParticipants" => Values::array_get(
                $payload,
                "coached_participants"
            ),
            "participantRegion" => Values::array_get(
                $payload,
                "participant_region"
            ),
            "conferenceRegion" => Values::array_get(
                $payload,
                "conference_region"
            ),
        ...
        $this->solution = [
            ...
            "participantSid" =>
                $participantSid ?: $this->properties["participantSid"],
        ];
    }
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Insights.V1.ConferenceParticipantInstance " .
            \implode(" ", $context) .
            "]";
    }
}
