...
class ConferenceInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "createTime" => Deserialize::dateTime(
                Values::array_get($payload, "create_time")
            ),
            ...
            "durationSeconds" => Values::array_get(
                $payload,
                "duration_seconds"
            ),
            "connectDurationSeconds" => Values::array_get(
                $payload,
                "connect_duration_seconds"
            ),
            "status" => Values::array_get($payload, "status"),
            "maxParticipants" => Values::array_get(
                $payload,
                "max_participants"
            ),
            "maxConcurrentParticipants" => Values::array_get(
                $payload,
                "max_concurrent_participants"
            ),
            "uniqueParticipants" => Values::array_get(
                $payload,
                "unique_participants"
            ),
            ...
            "mixerRegionRequested" => Values::array_get(
                $payload,
                "mixer_region_requested"
            ),
            "recordingEnabled" => Values::array_get(
                $payload,
                "recording_enabled"
            ),
            ...
            "processingState" => Values::array_get(
                $payload,
                "processing_state"
            ),
        ...
        $this->solution = [
            "conferenceSid" =>
                $conferenceSid ?: $this->properties["conferenceSid"],
        ];
    }
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Insights.V1.ConferenceInstance " .
            \implode(" ", $context) .
            "]";
    }
}
