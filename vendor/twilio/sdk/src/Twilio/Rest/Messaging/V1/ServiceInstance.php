...
class ServiceInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "inboundRequestUrl" => Values::array_get(
                $payload,
                "inbound_request_url"
            ),
            ...
            "scanMessageContent" => Values::array_get(
                $payload,
                "scan_message_content"
            ),
            "fallbackToLongCode" => Values::array_get(
                $payload,
                "fallback_to_long_code"
            ),
            "areaCodeGeomatch" => Values::array_get(
                $payload,
                "area_code_geomatch"
            ),
            "synchronousValidation" => Values::array_get(
                $payload,
            ...
            "usAppToPersonRegistered" => Values::array_get(
                $payload,
                "us_app_to_person_registered"
            ),
            "useInboundWebhookOnNumber" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Messaging.V1.ServiceInstance " .
            \implode(" ", $context) .
            "]";
    }
}
