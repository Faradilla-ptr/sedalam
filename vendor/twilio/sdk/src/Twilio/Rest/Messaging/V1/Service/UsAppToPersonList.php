...
class UsAppToPersonList extends ListResource
{
    ...
    public function create(
        ...
        $data = Values::of([
            ...
            "OptInKeywords" => Serialize::map(
                $options["optInKeywords"],
                function ($e) {
                    return $e;
                }
            ),
            "OptOutKeywords" => Serialize::map(
                $options["optOutKeywords"],
                function ($e) {
                    return $e;
                }
            ),
            "HelpKeywords" => Serialize::map(
                $options["helpKeywords"],
                function ($e) {
                    return $e;
                }
            ),
            "SubscriberOptIn" => Serialize::booleanToString(
                $options["subscriberOptIn"]
            ),
            "AgeGated" => Serialize::booleanToString($options["ageGated"]),
            "DirectLending" => Serialize::booleanToString(
                $options["directLending"]
            ),
        ]);
