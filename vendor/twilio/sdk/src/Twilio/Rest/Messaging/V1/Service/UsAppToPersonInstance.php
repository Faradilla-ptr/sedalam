...
class UsAppToPersonInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "brandRegistrationSid" => Values::array_get(
                $payload,
            ...
            "usAppToPersonUsecase" => Values::array_get(
                $payload,
                "us_app_to_person_usecase"
            ),
            "hasEmbeddedLinks" => Values::array_get(
                $payload,
                "has_embedded_links"
            ),
            "hasEmbeddedPhone" => Values::array_get(
                $payload,
                "has_embedded_phone"
            ),
            "subscriberOptIn" => Values::array_get(
                $payload,
                "subscriber_opt_in"
            ),
            ...
            "isExternallyRegistered" => Values::array_get(
                $payload,
