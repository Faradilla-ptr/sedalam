...
class TollfreeVerificationList extends ListResource
{
    ...
    public function create(
        ...
        $data = Values::of([
            ...
            "UseCaseCategories" => Serialize::map($useCaseCategories, function (
                $e
            ) {
                return $e;
            }),
            ...
            "OptInImageUrls" => Serialize::map($optInImageUrls, function ($e) {
                return $e;
            }),
            "OptInType" => $optInType,
    ...
    public function page(
        ...
        $params = Values::of([
            ...
            "ExternalReferenceId" => $options["externalReferenceId"],
            "IncludeSubAccounts" => Serialize::booleanToString(
        ...
        return new TollfreeVerificationPage(
            $this->version,
            $response,
            $this->solution
        );
