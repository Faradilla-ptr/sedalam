...
class DomainConfigContext extends InstanceContext
{
    ...
    public function __construct(Version $version, $domainSid)
    {
        ...
        $this->uri =
            "/LinkShortening/Domains/" . \rawurlencode($domainSid) . "/Config";
    }
    ...
    public function update(array $options = []): DomainConfigInstance
    {
        ...
        $data = Values::of([
            ...
            "ContinueOnFailure" => Serialize::booleanToString(
                $options["continueOnFailure"]
            ),
            "DisableHttps" => Serialize::booleanToString(
                $options["disableHttps"]
            ),
        ]);
