 ...
 */
class LinkshorteningMessagingServiceDomainAssociationInstance extends
    InstanceResource
{
    /**
    ...
    public function __construct(
        ...
        $this->solution = [
            "messagingServiceSid" =>
                $messagingServiceSid ?:
                $this->properties["messagingServiceSid"],
        ];
    }
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Messaging.V1.LinkshorteningMessagingServiceDomainAssociationInstance " .
            \implode(" ", $context) .
            "]";
    }
}
