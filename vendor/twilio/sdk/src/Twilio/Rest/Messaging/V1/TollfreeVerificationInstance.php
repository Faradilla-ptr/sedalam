...
class TollfreeVerificationInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "trustProductSid" => Values::array_get(
                $payload,
                "trust_product_sid"
            ),
            ...
            "regulatedItemSid" => Values::array_get(
                $payload,
                "regulated_item_sid"
            ),
            "businessName" => Values::array_get($payload, "business_name"),
            "businessStreetAddress" => Values::array_get(
                $payload,
                "business_street_address"
            ),
            "businessStreetAddress2" => Values::array_get(
                $payload,
                "business_street_address2"
            ),
            "businessCity" => Values::array_get($payload, "business_city"),
            "businessStateProvinceRegion" => Values::array_get(
                $payload,
                "business_state_province_region"
            ),
            "businessPostalCode" => Values::array_get(
                $payload,
                "business_postal_code"
            ),
            "businessCountry" => Values::array_get(
                $payload,
                "business_country"
            ),
            "businessWebsite" => Values::array_get(
                $payload,
                "business_website"
            ),
            "businessContactFirstName" => Values::array_get(
                $payload,
                "business_contact_first_name"
            ),
            "businessContactLastName" => Values::array_get(
                $payload,
                "business_contact_last_name"
            ),
            "businessContactEmail" => Values::array_get(
                $payload,
                "business_contact_email"
            ),
            "businessContactPhone" => Values::array_get(
                $payload,
                "business_contact_phone"
            ),
            "notificationEmail" => Values::array_get(
                $payload,
                "notification_email"
            ),
            "useCaseCategories" => Values::array_get(
                $payload,
                "use_case_categories"
            ),
            "useCaseSummary" => Values::array_get($payload, "use_case_summary"),
            "productionMessageSample" => Values::array_get(
                $payload,
                "production_message_sample"
            ),
            "optInImageUrls" => Values::array_get(
                $payload,
                "opt_in_image_urls"
            ),
            "optInType" => Values::array_get($payload, "opt_in_type"),
            "messageVolume" => Values::array_get($payload, "message_volume"),
            "additionalInformation" => Values::array_get(
                $payload,
                "additional_information"
            ),
            "tollfreePhoneNumberSid" => Values::array_get(
                $payload,
                "tollfree_phone_number_sid"
            ),
            "status" => Values::array_get($payload, "status"),
            "url" => Values::array_get($payload, "url"),
            "rejectionReason" => Values::array_get(
                $payload,
                "rejection_reason"
            ),
            "errorCode" => Values::array_get($payload, "error_code"),
            "editExpiration" => Deserialize::dateTime(
                Values::array_get($payload, "edit_expiration")
            ),
            "editAllowed" => Values::array_get($payload, "edit_allowed"),
            "rejectionReasons" => Values::array_get(
                $payload,
                "rejection_reasons"
            ),
            "resourceLinks" => Values::array_get($payload, "resource_links"),
            "externalReferenceId" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Messaging.V1.TollfreeVerificationInstance " .
            \implode(" ", $context) .
            "]";
    }
}
