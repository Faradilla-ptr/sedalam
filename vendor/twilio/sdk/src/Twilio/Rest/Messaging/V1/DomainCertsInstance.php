...
class DomainCertsInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "dateExpires" => Deserialize::dateTime(
                Values::array_get($payload, "date_expires")
            ),
            ...
            "certInValidation" => Values::array_get(
                $payload,
                "cert_in_validation"
            ),
        ];
        ...
        $this->solution = [
            "domainSid" => $domainSid ?: $this->properties["domainSid"],
        ];
    }
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Messaging.V1.DomainCertsInstance " .
            \implode(" ", $context) .
            "]";
    }
}
