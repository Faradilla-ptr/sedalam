...
class ServiceList extends ListResource
{
    ...
    public function create(
        ...
        $data = Values::of([
            ...
            "StickySender" => Serialize::booleanToString(
                $options["stickySender"]
            ),
            "MmsConverter" => Serialize::booleanToString(
                $options["mmsConverter"]
            ),
            "SmartEncoding" => Serialize::booleanToString(
                $options["smartEncoding"]
            ),
            "ScanMessageContent" => $options["scanMessageContent"],
            "FallbackToLongCode" => Serialize::booleanToString(
                $options["fallbackToLongCode"]
            ),
            "AreaCodeGeomatch" => Serialize::booleanToString(
                $options["areaCodeGeomatch"]
            ),
            "ValidityPeriod" => $options["validityPeriod"],
            "SynchronousValidation" => Serialize::booleanToString(
                $options["synchronousValidation"]
            ),
            "Usecase" => $options["usecase"],
            "UseInboundWebhookOnNumber" => Serialize::booleanToString(
                $options["useInboundWebhookOnNumber"]
            ),
        ]);
