...
class BrandRegistrationInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "customerProfileBundleSid" => Values::array_get(
                $payload,
                "customer_profile_bundle_sid"
            ),
            "a2PProfileBundleSid" => Values::array_get(
                $payload,
            ...
            "governmentEntity" => Values::array_get(
                $payload,
                "government_entity"
            ),
            "taxExemptStatus" => Values::array_get(
                $payload,
                "tax_exempt_status"
            ),
            "skipAutomaticSecVet" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Messaging.V1.BrandRegistrationInstance " .
            \implode(" ", $context) .
            "]";
    }
}
