...
class FlexUserInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "createdDate" => Deserialize::dateTime(
                Values::array_get($payload, "created_date")
            ),
            "updatedDate" => Deserialize::dateTime(
                Values::array_get($payload, "updated_date")
            ),
        ...
        $this->solution = [
            "instanceSid" => $instanceSid ?: $this->properties["instanceSid"],
            "flexUserSid" => $flexUserSid ?: $this->properties["flexUserSid"],
        ];
    }
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.FlexApi.V2.FlexUserInstance " .
            \implode(" ", $context) .
            "]";
    }
}
