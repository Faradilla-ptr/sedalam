...
abstract class PluginVersionsOptions
{
    ...
    public static function fetch(
        ...
        return new FetchPluginVersionsOptions($flexMetadata);
    }
    ...
    public static function read(
        ...
        return new ReadPluginVersionsOptions($flexMetadata);
    }
}
...
class CreatePluginVersionsOptions extends Options
{
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.FlexApi.V1.CreatePluginVersionsOptions " .
            $options .
            "]";
    }
}
...
class FetchPluginVersionsOptions extends Options
{
    ...
    {
        $options = \http_build_query(Values::of($this->options), "", " ");
        return "[Twilio.FlexApi.V1.FetchPluginVersionsOptions " .
            $options .
            "]";
    }
}
