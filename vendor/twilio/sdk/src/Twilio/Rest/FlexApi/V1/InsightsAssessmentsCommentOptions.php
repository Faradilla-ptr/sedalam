...
abstract class InsightsAssessmentsCommentOptions
{
    ...
    public static function create(
        ...
        return new CreateInsightsAssessmentsCommentOptions($authorization);
    }
...
class CreateInsightsAssessmentsCommentOptions extends Options
{
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.FlexApi.V1.CreateInsightsAssessmentsCommentOptions " .
            $options .
            "]";
    }
}
...
class ReadInsightsAssessmentsCommentOptions extends Options
{
    ...
    {
        $options = \http_build_query(Values::of($this->options), "", " ");
        return "[Twilio.FlexApi.V1.ReadInsightsAssessmentsCommentOptions " .
            $options .
            "]";
    }
}
