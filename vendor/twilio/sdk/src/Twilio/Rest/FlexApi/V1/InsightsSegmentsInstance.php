...
class InsightsSegmentsInstance extends InstanceResource
{
    ...
    public function __construct(Version $version, array $payload)
    {
        ...
        $this->properties = [
            ...
            "externalContact" => Values::array_get(
                $payload,
                "external_contact"
            ),
            "externalSegmentLinkId" => Values::array_get(
                $payload,
                "external_segment_link_id"
            ),
            "date" => Values::array_get($payload, "date"),
            "accountId" => Values::array_get($payload, "account_id"),
            "externalSegmentLink" => Values::array_get(
                $payload,
            ...
            "agentTeamNameInHierarchy" => Values::array_get(
                $payload,
