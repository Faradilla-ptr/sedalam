...
class FlexFlowList extends ListResource
{
    ...
    public function create(
        ...
        $data = Values::of([
            ...
            "Integration.CreationOnMessage" => Serialize::booleanToString(
                $options["integrationCreationOnMessage"]
            ),
            "LongLived" => Serialize::booleanToString($options["longLived"]),
            "JanitorEnabled" => Serialize::booleanToString(
                $options["janitorEnabled"]
            ),
