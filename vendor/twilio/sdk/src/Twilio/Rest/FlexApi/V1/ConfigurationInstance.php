...
class ConfigurationInstance extends InstanceResource
{
    ...
    public function __construct(Version $version, array $payload)
    {
        ...
        $this->properties = [
            ...
            "taskrouterWorkspaceSid" => Values::array_get(
                $payload,
                "taskrouter_workspace_sid"
            ),
            "taskrouterTargetWorkflowSid" => Values::array_get(
                $payload,
                "taskrouter_target_workflow_sid"
            ),
            "taskrouterTargetTaskqueueSid" => Values::array_get(
                $payload,
                "taskrouter_target_taskqueue_sid"
            ),
            "taskrouterTaskqueues" => Values::array_get(
                $payload,
                "taskrouter_taskqueues"
            ),
            "taskrouterSkills" => Values::array_get(
                $payload,
                "taskrouter_skills"
            ),
            "taskrouterWorkerChannels" => Values::array_get(
                $payload,
                "taskrouter_worker_channels"
            ),
            "taskrouterWorkerAttributes" => Values::array_get(
                $payload,
                "taskrouter_worker_attributes"
            ),
            "taskrouterOfflineActivitySid" => Values::array_get(
                $payload,
                "taskrouter_offline_activity_sid"
            ),
            "runtimeDomain" => Values::array_get($payload, "runtime_domain"),
            "messagingServiceInstanceSid" => Values::array_get(
                $payload,
                "messaging_service_instance_sid"
            ),
            "chatServiceInstanceSid" => Values::array_get(
                $payload,
                "chat_service_instance_sid"
            ),
            "flexServiceInstanceSid" => Values::array_get(
                $payload,
                "flex_service_instance_sid"
            ),
            "flexInstanceSid" => Values::array_get(
                $payload,
                "flex_instance_sid"
            ),
            ...
            "callRecordingEnabled" => Values::array_get(
                $payload,
                "call_recording_enabled"
            ),
            "callRecordingWebhookUrl" => Values::array_get(
                $payload,
            ...
            "publicAttributes" => Values::array_get(
                $payload,
                "public_attributes"
            ),
            "pluginServiceEnabled" => Values::array_get(
                $payload,
                "plugin_service_enabled"
            ),
            "pluginServiceAttributes" => Values::array_get(
                $payload,
                "plugin_service_attributes"
            ),
            "integrations" => Values::array_get($payload, "integrations"),
            "outboundCallFlows" => Values::array_get(
                $payload,
                "outbound_call_flows"
            ),
            "serverlessServiceSids" => Values::array_get(
                $payload,
                "serverless_service_sids"
            ),
            "queueStatsConfiguration" => Values::array_get(
                $payload,
            ...
            "flexInsightsDrilldown" => Values::array_get(
                $payload,
                "flex_insights_drilldown"
            ),
            "flexUrl" => Values::array_get($payload, "flex_url"),
            "channelConfigs" => Values::array_get($payload, "channel_configs"),
            "debuggerIntegration" => Values::array_get(
                $payload,
                "debugger_integration"
            ),
            "flexUiStatusReport" => Values::array_get(
                $payload,
                "flex_ui_status_report"
            ),
            "agentConvEndMethods" => Values::array_get(
                $payload,
