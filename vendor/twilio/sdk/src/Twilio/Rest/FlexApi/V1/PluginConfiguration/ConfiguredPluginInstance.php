...
class ConfiguredPluginInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "configurationSid" => Values::array_get(
                $payload,
                "configuration_sid"
            ),
            "pluginSid" => Values::array_get($payload, "plugin_sid"),
            "pluginVersionSid" => Values::array_get(
                $payload,
                "plugin_version_sid"
            ),
            ...
            "pluginVersionArchived" => Values::array_get(
                $payload,
        ...
        $this->solution = [
            ...
            "pluginSid" => $pluginSid ?: $this->properties["pluginSid"],
        ];
    }
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.FlexApi.V1.ConfiguredPluginInstance " .
            \implode(" ", $context) .
            "]";
    }
}
