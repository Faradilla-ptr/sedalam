...
abstract class InsightsQuestionnairesCategoryOptions
{
    ...
    public static function create(
        ...
        return new CreateInsightsQuestionnairesCategoryOptions($authorization);
    }
    ...
    public static function delete(
        ...
        return new DeleteInsightsQuestionnairesCategoryOptions($authorization);
    }
    ...
    public static function read(
        ...
        return new ReadInsightsQuestionnairesCategoryOptions($authorization);
    }
    ...
    public static function update(
        ...
        return new UpdateInsightsQuestionnairesCategoryOptions($authorization);
    }
}
...
class CreateInsightsQuestionnairesCategoryOptions extends Options
{
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.FlexApi.V1.CreateInsightsQuestionnairesCategoryOptions " .
            $options .
            "]";
    }
}
...
class DeleteInsightsQuestionnairesCategoryOptions extends Options
{
    ...
    {
        $options = \http_build_query(Values::of($this->options), "", " ");
        return "[Twilio.FlexApi.V1.DeleteInsightsQuestionnairesCategoryOptions " .
            $options .
            "]";
    }
}
...
class ReadInsightsQuestionnairesCategoryOptions extends Options
{
    ...
    {
        $options = \http_build_query(Values::of($this->options), "", " ");
        return "[Twilio.FlexApi.V1.ReadInsightsQuestionnairesCategoryOptions " .
            $options .
            "]";
    }
}
...
class UpdateInsightsQuestionnairesCategoryOptions extends Options
{
    ...
    {
        $options = \http_build_query(Values::of($this->options), "", " ");
        return "[Twilio.FlexApi.V1.UpdateInsightsQuestionnairesCategoryOptions " .
            $options .
            "]";
    }
}
