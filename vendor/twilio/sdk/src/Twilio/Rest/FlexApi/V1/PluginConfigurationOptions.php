...
abstract class PluginConfigurationOptions
{
    ...
    public static function fetch(
        ...
        return new FetchPluginConfigurationOptions($flexMetadata);
    }
    ...
    public static function read(
        ...
        return new ReadPluginConfigurationOptions($flexMetadata);
    }
}
...
class CreatePluginConfigurationOptions extends Options
{
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.FlexApi.V1.CreatePluginConfigurationOptions " .
            $options .
            "]";
    }
}
...
class FetchPluginConfigurationOptions extends Options
{
    ...
    {
        $options = \http_build_query(Values::of($this->options), "", " ");
        return "[Twilio.FlexApi.V1.FetchPluginConfigurationOptions " .
            $options .
            "]";
    }
}
...
class ReadPluginConfigurationOptions extends Options
{
    ...
    {
        $options = \http_build_query(Values::of($this->options), "", " ");
        return "[Twilio.FlexApi.V1.ReadPluginConfigurationOptions " .
            $options .
            "]";
    }
}
