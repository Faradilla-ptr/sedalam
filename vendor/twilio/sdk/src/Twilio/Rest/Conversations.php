...
class Conversations extends ConversationsBase
{
     ...
     */
    protected function contextAddressConfigurations(
        string $sid
     ...
     *                    resource.
     */
    protected function contextConversations(
        string $sid
     ...
     *                    resource.
     */
    protected function contextCredentials(
        string $sid
     ...
     */
    protected function contextRoles(
        string $sid
    ...
    protected function contextServices(
        string $sid
    ): \Twilio\Rest\Conversations\V1\ServiceContext {
