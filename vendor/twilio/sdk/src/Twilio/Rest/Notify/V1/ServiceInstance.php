...
class ServiceInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "apnCredentialSid" => Values::array_get(
                $payload,
                "apn_credential_sid"
            ),
            "gcmCredentialSid" => Values::array_get(
                $payload,
                "gcm_credential_sid"
            ),
            "fcmCredentialSid" => Values::array_get(
                $payload,
                "fcm_credential_sid"
            ),
            ...
            "facebookMessengerPageId" => Values::array_get(
                $payload,
                "facebook_messenger_page_id"
            ),
            "defaultApnNotificationProtocolVersion" => Values::array_get(
                $payload,
                "default_apn_notification_protocol_version"
            ),
            "defaultGcmNotificationProtocolVersion" => Values::array_get(
                $payload,
                "default_gcm_notification_protocol_version"
            ),
            "defaultFcmNotificationProtocolVersion" => Values::array_get(
                $payload,
            ...
            "defaultAlexaNotificationProtocolVersion" => Values::array_get(
                $payload,
                "default_alexa_notification_protocol_version"
            ),
            "deliveryCallbackUrl" => Values::array_get(
                $payload,
                "delivery_callback_url"
            ),
            "deliveryCallbackEnabled" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Notify.V1.ServiceInstance " .
            \implode(" ", $context) .
            "]";
    }
}
