...
class TaskQueueCumulativeStatisticsInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "avgTaskAcceptanceTime" => Values::array_get(
                $payload,
                "avg_task_acceptance_time"
            ),
            "startTime" => Deserialize::dateTime(
                Values::array_get($payload, "start_time")
            ),
            "endTime" => Deserialize::dateTime(
                Values::array_get($payload, "end_time")
            ),
            "reservationsCreated" => Values::array_get(
                $payload,
                "reservations_created"
            ),
            "reservationsAccepted" => Values::array_get(
                $payload,
                "reservations_accepted"
            ),
            "reservationsRejected" => Values::array_get(
                $payload,
                "reservations_rejected"
            ),
            "reservationsTimedOut" => Values::array_get(
                $payload,
                "reservations_timed_out"
            ),
            "reservationsCanceled" => Values::array_get(
                $payload,
                "reservations_canceled"
            ),
            "reservationsRescinded" => Values::array_get(
                $payload,
                "reservations_rescinded"
            ),
            "splitByWaitTime" => Values::array_get(
                $payload,
                "split_by_wait_time"
            ),
            "taskQueueSid" => Values::array_get($payload, "task_queue_sid"),
            "waitDurationUntilAccepted" => Values::array_get(
                $payload,
                "wait_duration_until_accepted"
            ),
            "waitDurationUntilCanceled" => Values::array_get(
                $payload,
                "wait_duration_until_canceled"
            ),
            "waitDurationInQueueUntilAccepted" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Taskrouter.V1.TaskQueueCumulativeStatisticsInstance " .
            \implode(" ", $context) .
            "]";
    }
}
