...
class TaskInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "assignmentStatus" => Values::array_get(
                $payload,
                "assignment_status"
            ),
            ...
            "taskQueueEnteredDate" => Deserialize::dateTime(
                Values::array_get($payload, "task_queue_entered_date")
            ),
            ...
            "virtualStartTime" => Deserialize::dateTime(
                Values::array_get($payload, "virtual_start_time")
            ),
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Taskrouter.V1.TaskInstance " .
            \implode(" ", $context) .
            "]";
    }
}
