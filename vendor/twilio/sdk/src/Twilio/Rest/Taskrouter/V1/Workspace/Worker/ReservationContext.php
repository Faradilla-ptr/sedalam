...
class ReservationContext extends InstanceContext
{
    ...
    public function update(array $options = []): ReservationInstance
    {
        ...
        $data = Values::of([
            ...
            "RedirectAccept" => Serialize::booleanToString(
                $options["redirectAccept"]
            ),
            ...
            "Beep" => $options["beep"],
            "StartConferenceOnEnter" => Serialize::booleanToString(
                $options["startConferenceOnEnter"]
            ),
            ...
            "DequeueStatusCallbackEvent" => Serialize::map(
                $options["dequeueStatusCallbackEvent"],
                function ($e) {
                    return $e;
                }
            ),
            "PostWorkActivitySid" => $options["postWorkActivitySid"],
            "EndConferenceOnCustomerExit" => Serialize::booleanToString(
                $options["endConferenceOnCustomerExit"]
            ),
            "BeepOnCustomerEntrance" => Serialize::booleanToString(
                $options["beepOnCustomerEntrance"]
            ),
