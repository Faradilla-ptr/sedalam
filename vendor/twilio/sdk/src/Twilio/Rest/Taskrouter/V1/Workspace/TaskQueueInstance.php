...
class TaskQueueInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "assignmentActivitySid" => Values::array_get(
                $payload,
                "assignment_activity_sid"
            ),
            "assignmentActivityName" => Values::array_get(
                $payload,
            ...
            "maxReservedWorkers" => Values::array_get(
                $payload,
                "max_reserved_workers"
            ),
            "reservationActivitySid" => Values::array_get(
                $payload,
                "reservation_activity_sid"
            ),
            "reservationActivityName" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Taskrouter.V1.TaskQueueInstance " .
            \implode(" ", $context) .
            "]";
    }
}
