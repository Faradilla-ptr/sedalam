...
class WorkspaceInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "defaultActivityName" => Values::array_get(
                $payload,
                "default_activity_name"
            ),
            "defaultActivitySid" => Values::array_get(
                $payload,
                "default_activity_sid"
            ),
            "eventCallbackUrl" => Values::array_get(
                $payload,
                "event_callback_url"
            ),
            "eventsFilter" => Values::array_get($payload, "events_filter"),
            "friendlyName" => Values::array_get($payload, "friendly_name"),
            "multiTaskEnabled" => Values::array_get(
                $payload,
                "multi_task_enabled"
            ),
            "sid" => Values::array_get($payload, "sid"),
            "timeoutActivityName" => Values::array_get(
                $payload,
                "timeout_activity_name"
            ),
            "timeoutActivitySid" => Values::array_get(
                $payload,
                "timeout_activity_sid"
            ),
            "prioritizeQueueOrder" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Taskrouter.V1.WorkspaceInstance " .
            \implode(" ", $context) .
            "]";
    }
}
