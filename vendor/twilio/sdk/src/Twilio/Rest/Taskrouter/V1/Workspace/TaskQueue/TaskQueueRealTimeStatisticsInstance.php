...
class TaskQueueRealTimeStatisticsInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "activityStatistics" => Values::array_get(
                $payload,
                "activity_statistics"
            ),
            "longestTaskWaitingAge" => Values::array_get(
                $payload,
                "longest_task_waiting_age"
            ),
            "longestTaskWaitingSid" => Values::array_get(
                $payload,
                "longest_task_waiting_sid"
            ),
            "longestRelativeTaskAgeInQueue" => Values::array_get(
                $payload,
                "longest_relative_task_age_in_queue"
            ),
            "longestRelativeTaskSidInQueue" => Values::array_get(
                $payload,
                "longest_relative_task_sid_in_queue"
            ),
            "taskQueueSid" => Values::array_get($payload, "task_queue_sid"),
            "tasksByPriority" => Values::array_get(
                $payload,
                "tasks_by_priority"
            ),
            "tasksByStatus" => Values::array_get($payload, "tasks_by_status"),
            "totalAvailableWorkers" => Values::array_get(
                $payload,
                "total_available_workers"
            ),
            "totalEligibleWorkers" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Taskrouter.V1.TaskQueueRealTimeStatisticsInstance " .
            \implode(" ", $context) .
            "]";
    }
}
