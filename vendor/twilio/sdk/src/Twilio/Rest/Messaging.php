...
class Messaging extends MessagingBase
{
     ...
     */
    protected function contextBrandRegistrations(
        string $sid
    ): \Twilio\Rest\Messaging\V1\BrandRegistrationContext {
     ...
     */
    protected function contextDomainCerts(
        string $domainSid
    ): \Twilio\Rest\Messaging\V1\DomainCertsContext {
     ...
     */
    protected function contextDomainConfig(
        string $domainSid
    ): \Twilio\Rest\Messaging\V1\DomainConfigContext {
     ...
     */
    protected function contextTollfreeVerifications(
        string $sid
    ): \Twilio\Rest\Messaging\V1\TollfreeVerificationContext {
