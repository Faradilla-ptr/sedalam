...
class FlexApi extends FlexApiBase
{
     ...
     *                    fetch
     */
    protected function contextChannel(
        string $sid
     ...
     */
    protected function contextFlexFlow(
        string $sid
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextInteraction(
        string $sid
    ): \Twilio\Rest\FlexApi\V1\InteractionContext {
     ...
     */
    protected function contextWebChannel(
        string $sid
