...
class MessageInteractionInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "inboundParticipantSid" => Values::array_get(
                $payload,
                "inbound_participant_sid"
            ),
            "inboundResourceSid" => Values::array_get(
                $payload,
                "inbound_resource_sid"
            ),
            "inboundResourceStatus" => Values::array_get(
                $payload,
                "inbound_resource_status"
            ),
            "inboundResourceType" => Values::array_get(
                $payload,
                "inbound_resource_type"
            ),
            "inboundResourceUrl" => Values::array_get(
                $payload,
                "inbound_resource_url"
            ),
            "outboundParticipantSid" => Values::array_get(
                $payload,
                "outbound_participant_sid"
            ),
            "outboundResourceSid" => Values::array_get(
                $payload,
                "outbound_resource_sid"
            ),
            "outboundResourceStatus" => Values::array_get(
                $payload,
                "outbound_resource_status"
            ),
            "outboundResourceType" => Values::array_get(
                $payload,
                "outbound_resource_type"
            ),
            "outboundResourceUrl" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Proxy.V1.MessageInteractionInstance " .
            \implode(" ", $context) .
            "]";
    }
}
