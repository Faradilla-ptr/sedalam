...
class SessionInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "dateStarted" => Deserialize::dateTime(
                Values::array_get($payload, "date_started")
            ),
            "dateEnded" => Deserialize::dateTime(
                Values::array_get($payload, "date_ended")
            ),
            "dateLastInteraction" => Deserialize::dateTime(
                Values::array_get($payload, "date_last_interaction")
            ),
            "dateExpiry" => Deserialize::dateTime(
                Values::array_get($payload, "date_expiry")
            ),
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Proxy.V1.SessionInstance " .
            \implode(" ", $context) .
            "]";
    }
}
