...
class ServiceContext extends InstanceContext
{
    ...
    public function update(array $options = []): ServiceInstance
    {
        ...
        $data = Values::of([
            ...
            "ReadStatusEnabled" => Serialize::booleanToString(
                $options["readStatusEnabled"]
            ),
            "ReachabilityEnabled" => Serialize::booleanToString(
                $options["reachabilityEnabled"]
            ),
            "TypingIndicatorTimeout" => $options["typingIndicatorTimeout"],
            "ConsumptionReportInterval" =>
                $options["consumptionReportInterval"],
            "Notifications.NewMessage.Enabled" => Serialize::booleanToString(
                $options["notificationsNewMessageEnabled"]
            ),
            ...
            "Notifications.NewMessage.BadgeCountEnabled" => Serialize::booleanToString(
                $options["notificationsNewMessageBadgeCountEnabled"]
            ),
            "Notifications.AddedToChannel.Enabled" => Serialize::booleanToString(
                $options["notificationsAddedToChannelEnabled"]
            ),
            ...
            "Notifications.RemovedFromChannel.Enabled" => Serialize::booleanToString(
                $options["notificationsRemovedFromChannelEnabled"]
            ),
            ...
            "Notifications.InvitedToChannel.Enabled" => Serialize::booleanToString(
                $options["notificationsInvitedToChannelEnabled"]
            ),
            ...
            "Notifications.LogEnabled" => Serialize::booleanToString(
                $options["notificationsLogEnabled"]
            ),
        ]);
