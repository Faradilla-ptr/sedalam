...
class Preview extends PreviewBase
{
     ...
     */
    protected function contextFleets(
        string $sid
     ...
     */
    protected function contextAuthorizationDocuments(
        string $sid
     ...
     */
    protected function contextHostedNumberOrders(
        string $sid
     ...
     */
    protected function contextAvailableAddOns(
        string $sid
    ): \Twilio\Rest\Preview\Marketplace\AvailableAddOnContext {
     ...
     */
    protected function contextInstalledAddOns(
        string $sid
    ): \Twilio\Rest\Preview\Marketplace\InstalledAddOnContext {
     ...
     */
    protected function contextServices(
        string $sid
     ...
     *                    resource.
     */
    protected function contextAssistants(
        string $sid
    ): \Twilio\Rest\Preview\Understand\AssistantContext {
     ...
     * @param string $sid The sid
     */
    protected function contextCommands(
        string $sid
     ...
     * @param string $sid The sid
     */
    protected function contextRatePlans(
        string $sid
     ...
     * @param string $sid The sid
     */
    protected function contextSims(
        string $sid
