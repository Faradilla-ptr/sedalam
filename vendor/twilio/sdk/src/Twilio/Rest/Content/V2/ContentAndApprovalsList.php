...
class ContentAndApprovalsList extends ListResource
{
    ...
    public function page(
        ...
        $params = Values::of([
            ...
            "DateCreatedAfter" => Serialize::iso8601DateTime(
                $options["dateCreatedAfter"]
            ),
            "DateCreatedBefore" => Serialize::iso8601DateTime(
                $options["dateCreatedBefore"]
            ),
            "ContentName" => $options["contentName"],
            "Content" => $options["content"],
            "Language" => Serialize::map($options["language"], function ($e) {
                return $e;
            }),
            "ContentType" => Serialize::map($options["contentType"], function (
                $e
            ) {
                return $e;
            }),
            "ChannelEligibility" => Serialize::map(
                $options["channelEligibility"],
                function ($e) {
                    return $e;
                }
            ),
        ...
        return new ContentAndApprovalsPage(
            $this->version,
            $response,
            $this->solution
        );
