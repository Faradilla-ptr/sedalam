...
abstract class ContentModels
{
     ...
     */
    public static function createTwilioLocation(
        array $payload = []
    ): TwilioLocation {
     ...
     */
    public static function createTwilioListPicker(
        array $payload = []
    ): TwilioListPicker {
     ...
     */
    public static function createCallToActionAction(
        array $payload = []
    ): CallToActionAction {
     ...
     */
    public static function createTwilioCallToAction(
        array $payload = []
    ): TwilioCallToAction {
     ...
     * @property string $id
     */
    public static function createQuickReplyAction(
        array $payload = []
    ): QuickReplyAction {
     ...
     */
    public static function createTwilioQuickReply(
        array $payload = []
    ): TwilioQuickReply {
     ...
     */
    public static function createTwilioCatalog(
        array $payload = []
    ): TwilioCatalog {
     ...
     * @property string $id
     */
    public static function createCarouselAction(
        array $payload = []
    ): CarouselAction {
     ...
     */
    public static function createTwilioCarousel(
        array $payload = []
    ): TwilioCarousel {
     ...
     * @property string $type
     */
    public static function createFlowsPageComponent(
        array $payload = []
    ): FlowsPageComponent {
     ...
     */
    public static function createTwilioSchedule(
        array $payload = []
    ): TwilioSchedule {
     ...
     */
    public static function createAuthenticationAction(
        array $payload = []
     ...
     */
    public static function createWhatsappAuthentication(
        array $payload = []
     ...
     */
    public static function createContentCreateRequest(
        array $payload = []
...
class WhatsappAuthentication implements \JsonSerializable
{
    ...
    public function __construct(array $payload = [])
    {
        $this->addSecurityRecommendation = Values::array_get(
            $payload,
            "add_security_recommendation"
        );
        $this->codeExpirationMinutes = Values::array_get(
            $payload,
...
class Types implements \JsonSerializable
{
    ...
    public function __construct(array $payload = [])
    {
        ...
        $this->twilioListPicker = Values::array_get(
            $payload,
            "twilio/list-picker"
        );
        $this->twilioCallToAction = Values::array_get(
            $payload,
            "twilio/call-to-action"
        );
        $this->twilioQuickReply = Values::array_get(
            $payload,
            "twilio/quick-reply"
        );
        ...
        $this->whatsappAuthentication = Values::array_get(
            $payload,
