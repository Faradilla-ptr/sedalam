...
class NumberInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            "destinationNumber" => Values::array_get(
                $payload,
                "destination_number"
            ),
            "originationNumber" => Values::array_get(
                $payload,
                "origination_number"
            ),
            "country" => Values::array_get($payload, "country"),
            "isoCountry" => Values::array_get($payload, "iso_country"),
            "terminatingPrefixPrices" => Values::array_get(
                $payload,
                "terminating_prefix_prices"
            ),
            "originatingCallPrice" => Values::array_get(
                $payload,
        ...
        $this->solution = [
            "destinationNumber" =>
                $destinationNumber ?: $this->properties["destinationNumber"],
        ];
    }
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Pricing.V2.NumberInstance " .
            \implode(" ", $context) .
            "]";
    }
}
