...
class Supersim extends SupersimBase
{
     ...
     */
    protected function contextEsimProfiles(
        string $sid
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextIpCommands(
        string $sid
     ...
     */
    protected function contextNetworks(
        string $sid
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextNetworkAccessProfiles(
        string $sid
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextSmsCommands(
        string $sid
