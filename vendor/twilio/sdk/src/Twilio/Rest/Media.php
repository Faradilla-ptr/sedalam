...
class Media extends MediaBase
{
     ...
     */
    protected function contextMediaProcessor(
        string $sid
    ): \Twilio\Rest\Media\V1\MediaProcessorContext {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextMediaRecording(
        string $sid
    ): \Twilio\Rest\Media\V1\MediaRecordingContext {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextPlayerStreamer(
        string $sid
