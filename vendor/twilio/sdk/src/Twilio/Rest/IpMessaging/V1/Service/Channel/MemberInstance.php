...
class MemberInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "lastConsumedMessageIndex" => Values::array_get(
                $payload,
                "last_consumed_message_index"
            ),
            "lastConsumptionTimestamp" => Deserialize::dateTime(
                Values::array_get($payload, "last_consumption_timestamp")
            ),
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.IpMessaging.V1.MemberInstance " .
            \implode(" ", $context) .
            "]";
    }
}
