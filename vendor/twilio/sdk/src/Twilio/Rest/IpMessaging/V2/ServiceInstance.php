...
class ServiceInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "defaultServiceRoleSid" => Values::array_get(
                $payload,
                "default_service_role_sid"
            ),
            "defaultChannelRoleSid" => Values::array_get(
                $payload,
                "default_channel_role_sid"
            ),
            "defaultChannelCreatorRoleSid" => Values::array_get(
                $payload,
                "default_channel_creator_role_sid"
            ),
            "readStatusEnabled" => Values::array_get(
                $payload,
                "read_status_enabled"
            ),
            "reachabilityEnabled" => Values::array_get(
                $payload,
                "reachability_enabled"
            ),
            "typingIndicatorTimeout" => Values::array_get(
                $payload,
                "typing_indicator_timeout"
            ),
            "consumptionReportInterval" => Values::array_get(
                $payload,
            ...
            "preWebhookRetryCount" => Values::array_get(
                $payload,
                "pre_webhook_retry_count"
            ),
            "postWebhookRetryCount" => Values::array_get(
                $payload,
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.IpMessaging.V2.ServiceInstance " .
            \implode(" ", $context) .
            "]";
    }
}
