...
class CountryList extends ListResource
{
    ...
    public function page(
        ...
        $params = Values::of([
            ...
            "LowRiskNumbersEnabled" => Serialize::booleanToString(
                $options["lowRiskNumbersEnabled"]
            ),
            "HighRiskSpecialNumbersEnabled" => Serialize::booleanToString(
                $options["highRiskSpecialNumbersEnabled"]
            ),
            "HighRiskTollfraudNumbersEnabled" => Serialize::booleanToString(
                $options["highRiskTollfraudNumbersEnabled"]
            ),
            "PageToken" => $pageToken,
            "Page" => $pageNumber,
            "PageSize" => $pageSize,
