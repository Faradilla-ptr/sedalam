...
class CountryInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "lowRiskNumbersEnabled" => Values::array_get(
                $payload,
                "low_risk_numbers_enabled"
            ),
            "highRiskSpecialNumbersEnabled" => Values::array_get(
                $payload,
                "high_risk_special_numbers_enabled"
            ),
            "highRiskTollfraudNumbersEnabled" => Values::array_get(
                $payload,
        ...
        $this->solution = [
            "isoCode" => $isoCode ?: $this->properties["isoCode"],
        ];
    }
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Voice.V1.CountryInstance " .
            \implode(" ", $context) .
            "]";
    }
}
