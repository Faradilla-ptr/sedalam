...
class ConfigurationInstance extends InstanceResource
{
    ...
    public function __construct(Version $version, array $payload)
    {
        ...
        $this->properties = [
            ...
            "defaultChatServiceSid" => Values::array_get(
                $payload,
                "default_chat_service_sid"
            ),
            "defaultMessagingServiceSid" => Values::array_get(
                $payload,
                "default_messaging_service_sid"
            ),
            "defaultInactiveTimer" => Values::array_get(
                $payload,
                "default_inactive_timer"
            ),
            "defaultClosedTimer" => Values::array_get(
                $payload,
