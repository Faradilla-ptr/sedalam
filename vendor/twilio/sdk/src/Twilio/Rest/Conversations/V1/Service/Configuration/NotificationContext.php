...
class NotificationContext extends InstanceContext
{
    ...
    public function update(array $options = []): NotificationInstance
    {
        ...
        $data = Values::of([
            ...
            "NewMessage.Enabled" => Serialize::booleanToString(
                $options["newMessageEnabled"]
            ),
            "NewMessage.Template" => $options["newMessageTemplate"],
            "NewMessage.Sound" => $options["newMessageSound"],
            "NewMessage.BadgeCountEnabled" => Serialize::booleanToString(
                $options["newMessageBadgeCountEnabled"]
            ),
            "AddedToConversation.Enabled" => Serialize::booleanToString(
                $options["addedToConversationEnabled"]
            ),
            ...
            "RemovedFromConversation.Enabled" => Serialize::booleanToString(
                $options["removedFromConversationEnabled"]
            ),
            ...
            "NewMessage.WithMedia.Enabled" => Serialize::booleanToString(
                $options["newMessageWithMediaEnabled"]
            ),
