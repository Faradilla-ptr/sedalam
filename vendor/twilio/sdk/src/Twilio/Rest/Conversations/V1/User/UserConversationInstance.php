...
class UserConversationInstance extends InstanceResource
{
    ...
    public function __construct(
        ...
        $this->properties = [
            ...
            "unreadMessagesCount" => Values::array_get(
                $payload,
                "unread_messages_count"
            ),
            "lastReadMessageIndex" => Values::array_get(
                $payload,
            ...
            "notificationLevel" => Values::array_get(
                $payload,
                "notification_level"
            ),
        ...
        $this->solution = [
            "userSid" => $userSid,
            "conversationSid" =>
                $conversationSid ?: $this->properties["conversationSid"],
        ];
    }
    ...
    public function __toString(): string
    {
        ...
        return "[Twilio.Conversations.V1.UserConversationInstance " .
            \implode(" ", $context) .
            "]";
    }
}
