...
abstract class KnowledgeModels
{
     ...
     */
    public static function createAssistantsV1ServiceCreatePolicyRequest(
        array $payload = []
     ...
     */
    public static function createAssistantsV1ServiceCreateKnowledgeRequest(
        array $payload = []
     ...
     */
    public static function createAssistantsV1ServiceUpdateKnowledgeRequest(
        array $payload = []
...
class AssistantsV1ServiceCreateKnowledgeRequest implements \JsonSerializable
{
    ...
    public function __construct(array $payload = [])
    {
        ...
        $this->description = Values::array_get($payload, "description");
        $this->knowledgeSourceDetails = Values::array_get(
            $payload,
