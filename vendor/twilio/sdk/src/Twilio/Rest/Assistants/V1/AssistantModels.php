...
abstract class AssistantModels
{
     ...
     */
    public static function createAssistantsV1ServiceCustomerAi(
        array $payload = []
     ...
     */
    public static function createAssistantsV1ServiceSegmentCredential(
        array $payload = []
     ...
     */
    public static function createAssistantsV1ServiceCreateAssistantRequest(
        array $payload = []
     ...
     * @property AssistantsV1ServiceSegmentCredential $segmentCredential
     */
    public static function createAssistantsV1ServiceUpdateAssistantRequest(
        array $payload = []
...
class AssistantsV1ServiceCustomerAi implements \JsonSerializable
{
    ...
    {
        $this->perceptionEngineEnabled = Values::array_get(
            $payload,
            "perception_engine_enabled"
        );
        $this->personalizationEngineEnabled = Values::array_get(
            $payload,
...
class AssistantsV1ServiceCreateAssistantRequest implements \JsonSerializable
{
    ...
    public function __construct(array $payload = [])
    {
        ...
        $this->personalityPrompt = Values::array_get(
            $payload,
            "personality_prompt"
        );
        $this->segmentCredential = Values::array_get(
            $payload,
            "segment_credential"
        );
    }
