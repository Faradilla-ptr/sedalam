...
class Voice extends VoiceBase
{
     ...
     */
    protected function contextArchivedCalls(
        \DateTime $date,
        string $sid
     ...
     */
    protected function contextByocTrunks(
        string $sid
    ): \Twilio\Rest\Voice\V1\ByocTrunkContext {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextConnectionPolicies(
        string $sid
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextIpRecords(
        string $sid
    ): \Twilio\Rest\Voice\V1\IpRecordContext {
     ...
     * @param string $sid The unique string that identifies the resource
     */
    protected function contextSourceIpMappings(
        string $sid
    ): \Twilio\Rest\Voice\V1\SourceIpMappingContext {
