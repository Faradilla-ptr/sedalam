...
class Video extends VideoBase
{
     ...
     */
    protected function contextCompositions(
        string $sid
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextCompositionHooks(
        string $sid
    ): \Twilio\Rest\Video\V1\CompositionHookContext {
     ...
     * @param string $sid The SID that identifies the resource to fetch
     */
    protected function contextRooms(
        string $sid
    ): \Twilio\Rest\Video\V1\RoomContext {
