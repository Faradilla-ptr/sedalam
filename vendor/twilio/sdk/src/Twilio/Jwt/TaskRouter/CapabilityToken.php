...
class CapabilityToken
{
    ...
    public function __construct(
        ...
        $this->allow(
            $this->baseWsUrl . "/" . $this->accountSid . "/" . $this->channelId,
            "GET",
            null,
            null
        );
    ...
    {
        if (
            !isset($this->accountSid) ||
            \strpos($this->accountSid, "AC") !== 0
        ) {
            throw new \Exception(
                "Invalid AccountSid provided: " . $this->accountSid
            );
        }
        if (
            !isset($this->workspaceSid) ||
            \strpos($this->workspaceSid, "WS") !== 0
        ) {
            throw new \Exception(
                "Invalid WorkspaceSid provided: " . $this->workspaceSid
            );
        }
        ...
        if ($prefix !== "WS" && $prefix !== "WK" && $prefix !== "WQ") {
            throw new \Exception(
                "Invalid ChannelId provided: " . $this->channelId
            );
        }
    }
