...
class CurlClient implements Client
{
    ...
    public function request(
        ...
        try {
            ...
            list($head, $body) =
                ...
                \preg_match(
                    "/\AHTTP\/1.\d 200 Connection established\Z/",
                    $parts[0]
                ) ||
                \preg_match(
                    "/\AHTTP\/1.\d 200 Tunnel established\Z/",
                    $parts[0]
                )
                    ? [$parts[1], $parts[2]]
                    : [$parts[0], $parts[1]];
            ...
            if (
                isset($options[CURLOPT_INFILE]) &&
                \is_resource($options[CURLOPT_INFILE])
            ) {
    ...
    public function options(
        ...
        if ($user && $password) {
            ...
            $options[CURLOPT_HTTPHEADER][] =
                "Authorization: " . $authStrategy->getAuthString();
        }
