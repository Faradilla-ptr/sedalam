...
final class Fill
{
    ...
    {
        return self::$default ?:
            (self::$default = self::uniformColor(new Gray(100), new Gray(0)));
    }
    ...
    public static function uniformGradient(
        ColorInterface $backgroundColor,
        Gradient $foregroundGradient
    ): self {
        return new self(
    ...
    public function getForegroundColor(): ColorInterface
    {
        if (null === $this->foregroundColor) {
            throw new RuntimeException(
                "Fill uses a gradient, thus no foreground color is available"
            );
        }
    ...
    public function getForegroundGradient(): Gradient
    {
        if (null === $this->foregroundGradient) {
            throw new RuntimeException(
                "Fill uses a single color, thus no foreground gradient is available"
            );
        }
