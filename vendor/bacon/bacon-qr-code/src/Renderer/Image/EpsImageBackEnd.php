...
final class EpsImageBackEnd implements ImageBackEndInterface
{
    ...
    public function new(int $size, ColorInterface $backgroundColor): void
    {
        ...
        if (
            $backgroundColor instanceof Alpha &&
            0 === $backgroundColor->getAlpha()
        ) {
            return;
        }
        ...
        $this->eps .= wordwrap(
            "0 0 m" .
                ...
                " z" .
                " " .
                $this->getColorSetString($backgroundColor) .
                " f\n",
            75,
            "\n "
        );
        ...
        foreach ($ops as $op) {
            switch (true) {
                ...
                case $op instanceof EllipticArc:
                    $pathData[] = $this->drawPathOperations(
                        $op->toCurves($fromX, $fromY),
                        $fromX,
                        $fromY
                    );
                    break;
