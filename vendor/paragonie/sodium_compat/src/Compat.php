...
class ParagonIE_Sodium_Compat
{
    ...
    public static function add(
        #[SensitiveParameter] string &$val,
        #[SensitiveParameter] string $addv
    ): void {
        ...
        try {
            return match ($variant) {
                self::BASE64_VARIANT_ORIGINAL
                    => ParagonIE_Sodium_Core_Base64_Original::decode(
                    $encoded,
                    true
                ),
                self::BASE64_VARIANT_ORIGINAL_NO_PADDING
                    => ParagonIE_Sodium_Core_Base64_Original::decode($encoded),
                self::BASE64_VARIANT_URLSAFE
                    => ParagonIE_Sodium_Core_Base64_UrlSafe::decode(
                    $encoded,
                    true
                ),
                self::BASE64_VARIANT_URLSAFE_NO_PADDING
                    => ParagonIE_Sodium_Core_Base64_UrlSafe::decode($encoded),
                default => throw new SodiumException(
    ...
    public static function bin2base64(
        #[SensitiveParameter] string $decoded,
        int $variant
    ): string {
        ...
        return match ($variant) {
            ...
            self::BASE64_VARIANT_ORIGINAL_NO_PADDING
                => ParagonIE_Sodium_Core_Base64_Original::encodeUnpadded(
                $decoded
            ),
            self::BASE64_VARIANT_URLSAFE
                => ParagonIE_Sodium_Core_Base64_UrlSafe::encode($decoded),
            self::BASE64_VARIANT_URLSAFE_NO_PADDING
                => ParagonIE_Sodium_Core_Base64_UrlSafe::encodeUnpadded(
                $decoded
            ),
            default => throw new SodiumException(
                "invalid base64 variant identifier"
     ...
     * @throws TypeError
     */
    public static function bin2hex(#[SensitiveParameter] string $string): string
    {
    ...
    public static function compare(
        #[SensitiveParameter] string $left,
        #[SensitiveParameter] string $right
    ): int {
        if (self::useNewSodiumAPI()) {
    ...
    public static function crypto_kx(
        #[SensitiveParameter] string $my_secret,
        string $their_public,
     ...
     * @throws TypeError
     */
    public static function crypto_sign_ed25519_pk_to_curve25519(
        string $pk
    ): string {
        /* Input validation: */
        if (
     ...
     * @throws TypeError
     */
    public static function increment(#[SensitiveParameter] string &$var): void
    {
        if (self::useNewSodiumAPI()) {
     ...
     * @throws SodiumException
     */
    public static function is_zero(#[SensitiveParameter] string $str): bool
    {
        $d = 0;
        for ($i = 0; $i < 32; ++$i) {
     ...
     */
    public static function memzero(#[SensitiveParameter] ?string &$var): void
    {
        if (is_null($var)) {
            return;
        }
    ...
    public static function pad(
        #[SensitiveParameter] string $unpadded,
        int $blockSize,
        bool $dontFallback = false
    ): string {
        if (self::useNewSodiumAPI() && !$dontFallback) {
    ...
    public static function unpad(
        #[SensitiveParameter] string $padded,
        int $blockSize,
        bool $dontFallback = false
    ): string {
        if (self::useNewSodiumAPI() && !$dontFallback) {
    ...
    public static function ristretto255_add(
        #[SensitiveParameter] string $p,
        #[SensitiveParameter] string $q,
        bool $dontFallback = false
    ): string {
        if (self::useNewSodiumAPI() && !$dontFallback) {
    ...
    public static function ristretto255_scalar_add(
        #[SensitiveParameter] string $x,
        #[SensitiveParameter] string $y,
        bool $dontFallback = false
    ): string {
        if (self::useNewSodiumAPI() && !$dontFallback) {
