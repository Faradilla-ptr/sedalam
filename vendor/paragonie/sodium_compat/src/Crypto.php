...
abstract class ParagonIE_Sodium_Crypto
{
    ...
    public static function box_keypair_from_secretkey_and_publickey(
        #[SensitiveParameter] string $sKey,
        string $pKey
    ): string {
     ...
     * @throws TypeError
     */
    public static function generichash_final(
        string $ctx,
        int $outlen = 32
    ): string {
        $out = new SplFixedArray($outlen);
     ...
     * @throws TypeError
     */
    public static function generichash_update(
        string $ctx,
        string $message
    ): string {
        // This ensures that ParagonIE_Sodium_Core_BLAKE2b::$iv is initialized
    ...
    public static function keyExchange(
        #[SensitiveParameter] string $my_sk,
        string $their_pk,
        string $client_pk,
        string $server_pk
    ): string {
