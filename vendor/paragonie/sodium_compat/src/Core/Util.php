...
abstract class ParagonIE_Sodium_Core_Util
{
    ...
    public static function abs(
        ...
        return ($integer ^ $negative) + (($negative >> $realSize) & 1);
    }
    ...
    public static function andStrings(
        #[SensitiveParameter] string $a,
        #[SensitiveParameter] string $b
    ): string {
        $len = self::strlen($a);
    ...
    public static function bin2hex(
        #[SensitiveParameter] string $binaryString
    ): string {
        $hex = "";
     ...
     * @throws TypeError
     */
    public static function chrToInt(#[SensitiveParameter] string $chr): int
    {
    ...
    public static function hex2bin(
        #[SensitiveParameter] string $hexString,
        string $ignore = "",
        ...
        while ($hex_pos < $hex_len) {
            ...
            if (($c_num0 | $c_alpha0) === 0) {
                if (
                    $ignore &&
                    $state === 0 &&
                    str_contains($ignore, self::intToChr($c))
                ) {
                    continue;
                }
                throw new RangeException(
     ...
     * @throws TypeError
     */
    public static function intToChr(#[SensitiveParameter] int $int): string
    {
        return pack("C", $int);
    }
     ...
     * @throws TypeError
     */
    public static function load_3(#[SensitiveParameter] string $string): int
    {
        /* Input validation: */
     ...
     * @throws TypeError
     */
    public static function load_4(#[SensitiveParameter] string $string): int
    {
        /* Input validation: */
     ...
     * @throws TypeError
     */
    public static function load64_le(#[SensitiveParameter] string $string): int
    {
        /* Input validation: */
        if (self::strlen($string) < 4) {
            throw new RangeException(
    ...
    public static function mul(
        #[SensitiveParameter] int $a,
        #[SensitiveParameter] int $b,
        int $size = 0
    ): int {
     ...
     * @throws TypeError
     */
    public static function strlen(#[SensitiveParameter] string $str): int
    {
