...
class ParagonIE_Sodium_Core_SecretStream_State
{
     ...
     * @return self
     */
    public function rekey(#[SensitiveParameter] string $newKeyAndNonce): self
    {
     ...
     * @return self
     */
    public function xorNonce(#[SensitiveParameter] string $str): self
    {
        $this->nonce = ParagonIE_Sodium_Core_Util::xorStrings(
            $this->getNonce(),
            str_pad(ParagonIE_Sodium_Core_Util::substr($str, 0, 8), 12, "\0")
        );
        return $this;
    }
