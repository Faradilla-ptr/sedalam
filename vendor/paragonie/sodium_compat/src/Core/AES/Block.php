...
class ParagonIE_Sodium_Core_AES_Block extends SplFixedArray
{
     ...
     * @return static
     */
    public function swapN(int $cl, int $ch, int $s, int $x, int $y): static
    {
     ...
     * @return static
     */
    public function swap2(int $x, int $y): static
    {
     ...
     * @return static
     */
    public function swap4(int $x, int $y): static
    {
     ...
     * @return static
     */
    public function swap8(int $x, int $y): static
    {
