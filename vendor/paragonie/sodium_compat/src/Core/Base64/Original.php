...
class ParagonIE_Sodium_Core_Base64_Original
{
     ...
     * @throws TypeError
     */
    public static function encode(#[SensitiveParameter] string $src): string
    {
     ...
     * @return int
     */
    protected static function decode6Bits(#[SensitiveParameter] int $src): int
    {
        $ret = -1;
