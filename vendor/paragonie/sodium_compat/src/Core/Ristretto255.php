...
class ParagonIE_Sodium_Core_Ristretto255 extends ParagonIE_Sodium_Core_Ed25519
{
     ...
     * @throws SodiumException
     */
    public static function fe_iszero(
        ParagonIE_Sodium_Core_Curve25519_Fe $f
    ): int {
        static $zero;
        if ($zero === null) {
     ...
     * @throws SodiumException
     */
    public static function is_valid_point(#[SensitiveParameter] string $p): int
    {
    ...
    public static function h2c_string_to_hash(
        ...
        return match ($hash_alg) {
            self::CORE_H2C_SHA256 => self::h2c_string_to_hash_sha256(
                $hLen,
                $ctx,
                $msg
            ),
            self::CORE_H2C_SHA512 => self::h2c_string_to_hash_sha512(
                $hLen,
                $ctx,
                $msg
            ),
