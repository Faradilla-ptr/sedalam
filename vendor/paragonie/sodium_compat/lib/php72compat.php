...
if (!is_callable("sodium_add")) {
     ...
     */
    function sodium_add(
        #[\SensitiveParameter] string &$string1,
        string $string2
    ): void {
...
if (!is_callable("sodium_crypto_kx_client_session_keys")) {
    ...
    function sodium_crypto_kx_client_session_keys(
        #[\SensitiveParameter] string $client_key_pair,
        string $server_key
    ): array {
...
if (!is_callable("sodium_crypto_kx_server_session_keys")) {
    ...
    function sodium_crypto_kx_server_session_keys(
        #[\SensitiveParameter] string $server_key_pair,
        string $client_key
    ): array {
...
if (!is_callable("sodium_increment")) {
     ...
     * @throws TypeError
     */
    function sodium_increment(#[\SensitiveParameter] string &$string): void
    {
