...
final class Middleware
{
    ...
    public static function log(
        ...
        if (
            !$formatter instanceof MessageFormatter &&
            !$formatter instanceof MessageFormatterInterface
        ) {
            throw new \LogicException(
                sprintf(
                    "Argument 2 to %s::log() must be of type %s",
                    self::class,
        ...
        return static function (callable $handler) use (
            ...
            return static function (
                RequestInterface $request,
                array $options = []
            ) use ($handler, $logger, $formatter, $logLevel) {
                return $handler($request, $options)->then(
