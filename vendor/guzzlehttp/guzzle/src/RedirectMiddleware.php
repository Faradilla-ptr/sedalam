...
class RedirectMiddleware
{
    ...
    public function checkRedirect(
        ...
        if (
            Psr7\UriComparator::isCrossOrigin(
                $request->getUri(),
                $nextRequest->getUri()
            ) &&
    ...
    public function modifyRequest(
        ...
        if (
            ...
            $modify["method"] = in_array($requestMethod, $safeMethods)
                ? $requestMethod
                : "GET";
            $modify["body"] = "";
        }
        ...
        if (
            isset($options["idn_conversion"]) &&
            $options["idn_conversion"] !== false
        ) {
            $idnOptions =
                $options["idn_conversion"] === true
                    ? \IDNA_DEFAULT
