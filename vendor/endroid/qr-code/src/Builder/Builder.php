...
final readonly class Builder implements BuilderInterface
{
    public function __construct(
        ...
        private FontInterface $labelFont = new Font(
            __DIR__ . "/../../assets/open_sans.ttf",
            16
        ),
    ...
    public function build(
        ...
        if (
            $this->validateResult &&
            !$this->writer instanceof ValidatingWriterInterface
        ) {
            throw ValidationException::createForUnsupportedWriter(
        ...
        $logo = $createLogo
            ? new Logo(
                ...
                resizeToHeight: $logoResizeToHeight ??
                    $this->logoResizeToHeight,
                punchoutBackground: $logoPunchoutBackground ??
                    $this->logoPunchoutBackground
            )
            : null;
