...
final readonly class ErrorCorrectionLevelConverter
{
    public static function convertToBaconErrorCorrectionLevel(
        ...
        return match ($errorCorrectionLevel) {
            ErrorCorrectionLevel::Low => BaconErrorCorrectionLevel::valueOf(
                "L"
            ),
            ErrorCorrectionLevel::Medium => BaconErrorCorrectionLevel::valueOf(
                "M"
            ),
            ErrorCorrectionLevel::Quartile
                => BaconErrorCorrectionLevel::valueOf("Q"),
            ErrorCorrectionLevel::High => BaconErrorCorrectionLevel::valueOf(
                "H"
            ),
        };
    }
